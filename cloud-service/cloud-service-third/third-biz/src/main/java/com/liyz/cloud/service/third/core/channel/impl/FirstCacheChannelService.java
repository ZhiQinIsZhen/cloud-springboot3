 ...
 */
@Service
public class FirstCacheChannelService<Q extends ThirdBaseDTO, T> extends AbstractChannelService<Q, T> {

    @Override
    public QueryStrategy getQueryStrategy() {
        return QueryStrategy.FIRST_CACHE;
    }
    ...
    public ParseResult<T> queryChannel(Q req, CacheEsService<Q, T> cacheEsService) {
        ...
        if (CollectionUtils.isEmpty(parseResult.getDataList())) {
